...
<!-- For checkpoint task examples and patterns, see @./.antigravity/get-shit-done/references/checkpoints.md -->
...
See `./.antigravity/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `./.antigravity/get-shit-done/workflows/verify-phase.md` for verification logic.
