...
```
Task(
  prompt="First, read ./.antigravity/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
**If found:**
1. Read validation template from `./.antigravity/get-shit-done/templates/VALIDATION.md`
...
```
Task(
  prompt="First, read ./.antigravity/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
Task(
  prompt="
    ...
    @./.antigravity/get-shit-done/references/checkpoints.md
    @./.antigravity/get-shit-done/references/tdd.md
    @./.antigravity/get-shit-done/references/model-profile-resolution.md
    </execution_context>
