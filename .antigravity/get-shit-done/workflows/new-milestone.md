...
- Use notify_user to explore features, priorities, constraints, scope
...
notify_user: "Research the domain ecosystem for new features before defining requirements?"
...
Use template: ./.antigravity/get-shit-done/templates/research-project/{FILE}
</output>
...
**Scope each category** via notify_user (multiSelect: true, header max 12 chars):
...
**Ask for approval** via notify_user:
