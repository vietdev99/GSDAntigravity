...
@./.antigravity/get-shit-done/references/git-integration.md
</required_reading>
...
```
If previous SUMMARY has unresolved "Issues Encountered" or "Next Phase Readiness" blockers: notify_user(header="Previous Issues", options: "Proceed anyway" | "Address first" | "Review previous").
</step>
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `./.antigravity/get-shit-done/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>

<step name="create_summary">
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `./.antigravity/get-shit-done/templates/summary.md`.
