...
notify_user(header="Archive Phases", question="Archive phase directories to milestones/?", options: "Yes — move to milestones/v[X.Y]-phases/" | "Skip — keep phases in place")
...
**If doesn't exist:** Create from template at `./.antigravity/get-shit-done/templates/retrospective.md`.
...
notify_user with options: Squash merge (Recommended), Merge with history, Delete without merging, Keep branches.
