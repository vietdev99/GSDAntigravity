...
Ask inline (freeform, NOT notify_user):
...
Based on what they said, ask follow-up questions that dig into their response. Use notify_user with options that probe what they mentioned — interpretations, clarifications, concrete examples.
...
When you could write a clear PROJECT.md, use notify_user:
...
```
Task(prompt="First, read ./.antigravity/agents/gsd-project-researcher.md for your role and instructions.
...
Use template: ./.antigravity/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: ./.antigravity/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: ./.antigravity/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ./.antigravity/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: ./.antigravity/get-shit-done/templates/research-project/SUMMARY.md
...
- Skip per-category notify_user loops
...
For each category, use notify_user:
