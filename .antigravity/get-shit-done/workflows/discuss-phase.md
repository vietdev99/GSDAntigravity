...
**Then use notify_user (multiSelect: true):**
- header: "Discuss"
...
2. **Ask 4 questions using notify_user:**
   - header: "[Area]" (max 12 chars — abbreviate if needed)
   - question: Specific decision for this area
   - options: 2-3 concrete choices (notify_user adds "Other" automatically), with the recommended choice highlighted and brief explanation why
...
Task(
  prompt="
    ...
    <execution_context>
    @./.antigravity/get-shit-done/workflows/plan-phase.md
